...
person2=0
person3=0
persons = int(input('후보자 수를 입력하시오 >>>'))
for i in range(persons):
    person = input(f'{i+1}번째 후보자의 이름을 입력하시오 >>>')
    candidates.append(person)

dict1 = {1:candidates[0], 2:candidates[1], 3:candidates[2]}

li1 = int(input('전체 투표 횟수를 입력하시오 >>>'))
for i in range(li1):
    li2=int(input(f'{i+1}번째 투표 {dict1} >>>'))
...
print(f'{dict1[1]}: {person1}표')
print(f'{dict1[2]}: {person2}표')
print(f'{dict1[3]}: {person3}표')
